package KhorneSyrup.PolyMath.Common.network.client;

import java.io.IOException;

import KhorneSyrup.PolyMath.PolyMath;
import KhorneSyrup.PolyMath.Common.lib.PolyMathPlayer;
import KhorneSyrup.PolyMath.Common.network.AbstractMessage.AbstractClientMessage;
...
public class SyncPlayerPropsMessage extends AbstractClientMessage<SyncPlayerPropsMessage>
{
	...
	public SyncPlayerPropsMessage(EntityPlayer player) {
		...
		PolyMathPlayer.get(player).saveNBTData(data);
	}
	...
	public void process(EntityPlayer player, Side side) {
		...
		PolyMath.logger.info("Synchronizing extended properties data on CLIENT");
		PolyMathPlayer.get(player).loadNBTData(data);
	}
}